                ...
                <div class="uk-width-medium-1-1">
                    <div class="uk-text-center">
                         <img class="logo_regular" src="{{ asset('admin/assets/img/logo_main.png') }}" alt="" height="15" width="100"/>
                          <span class="uk-text-muted"><address>Shop # A1, House # 56, Road # 11, Blook # F Banani, Dhaka-1213.<br>Cell:01862-444387<br>Web:www.opticalcarebd.com</address></span>
                    </div>
               </div>
            </div>
        <form method="POST" id="form_validation" class="uk-form-stacked">
           <div class="uk-grid uk-grid-small">
                ...
                <div class="uk-width-medium-8-10">
                    ...
                    <span class="uk-text-muted">{{$sell->address}}</span>
                    </p>
