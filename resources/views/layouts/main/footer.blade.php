      ...
      <div class="slider-items-products">
        <div id="brand-logo-slider" class="product-flexslider hidden-buttons">
          <div class="slider-items slider-width-col6"> 
            ...
            <!-- Item -->
            <div class="item"><a href="#"><img src="{{ asset('main/images/b-logo1.png') }}" alt="Image"></a> </div>
            <!-- End Item --> 
            
            <!-- Item -->
            <div class="item"><a href="#"><img src="{{ asset('main/images/b-logo2.png') }}" alt="Image"></a> </div>
            <!-- End Item --> 
            
            <!-- Item -->
            <div class="item"><a href="#"><img src="{{ asset('main/images/b-logo3.png') }}" alt="Image"></a> </div>
            <!-- End Item --> 
            
            <!-- Item -->
            <div class="item"><a href="#"><img src="{{ asset('main/images/b-logo4.png') }}" alt="Image"></a> </div>
            <!-- End Item --> 
            
            <!-- Item -->
            <div class="item"><a href="#"><img src="{{ asset('main/images/b-logo5.png') }}" alt="Image"></a> </div>
            <!-- End Item --> 
            
            <!-- Item -->
            <div class="item"><a href="#"><img src="{{ asset('main/images/b-logo6.png') }}" alt="Image"></a> </div>
            <!-- End Item --> 
  ...
  <footer>
    <section class="footer-navbar">
      ...
      <div class="footer-middle">
        <div class="container">
          <div class="row">
            <div style="text-align:center"><a href="index.html"><img src="{{ asset('main/images/footer-logo.png') }}" alt="footer-logo"></a></div>
            <address>
      ...
      <div class="footer-bottom">
        <div class="container">
          <div class="row">
            <div class="col-sm-5 col-xs-12 coppyright">&copy; 2017 Optical Care. All Rights Reserved.</div>
            <div class="col-sm-7 col-xs-12 company-links">
              <ul class="links">
                <li class="last">Developed by <a title="i-Soft" href="#">i-Soft</a></li>
              </ul>
            </div>
          </div>
        </div>
